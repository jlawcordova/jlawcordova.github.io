...
The challenge tests out fundamental knowledge on web and cloud development. Divided into 4 sections, I would have to:
...
I started off by writing the content for my resume. Knowing how to make a good resume is a whole 'nother topic. I'm not going to get into this blog, but I can share that I had [The Tech Resume](https://thetechresume.com/) by [Gergely Orosz](https://blog.pragmaticengineer.com/) guide me with writing mine. It's a good read so check it out if you're interested.
...
I used [Create React App](https://create-react-app.dev/) to initialize the project. I then made React components for each of the resume section. I applied this to all other sections, and eventually I had a structured website.
...
<figure>
  ...
  <figcaption>Overall backend using API Gateway, Lamdbda and DynamoDB</figcaption>
</figure>
...
The last part of the challenge is to write this blog. Making the whole website from frontend to backend is one thing. Writing about it and sharing it to the world is another. And with you reading this blog to completion, I have in turn also completed this challenge.
